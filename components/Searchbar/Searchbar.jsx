...
const Searchbar = () => {
  ...
  return (
    ...
    <div className=" bg-black  w-[90vw] sm:w-[60vm] md:w-[50vm] lg:w-[40vw] xl:w-max p-8 xl:pl-8 xl:pr-2 h-auto xl:h-[70px] rounded-3xl xl:rounded-full backdrop-blur-[20px] flex flex-col xl:flex-row items-center gap-6 mx-auto text-sm z-50">
      {/*event search*/}
      <EventSearch />
